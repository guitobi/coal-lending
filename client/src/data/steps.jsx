...
export const steps = [
  {
    icon: (
      <Phone className="w-10 h-10 text-stone-500 group-hover:text-orange-500" />
    ),
    title: "1. Order",
  ...
  {
    icon: (
      <Truck className="w-10 h-10 text-stone-500 group-hover:text-orange-500" />
    ),
  ...
  {
    icon: (
      <Wallet className="w-10 h-10 text-stone-500 group-hover:text-orange-500" />
    ),
