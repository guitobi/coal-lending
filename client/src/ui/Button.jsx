...
function Button({
  ...
  const styles = {
    primary:
      base +
      " text-base sm:text-lg md:text-xl px-6 py-2.5 sm:px-8 sm:py-3 md:px-10 md:py-4 text-white font-bold shadow-md hover:shadow-lg hover:brightness-110 bg-orange-500 border-yellow-600 hover:bg-orange-600 shadow-orange-400",
    secondary:
      base +
  ...
  const combinedClassName = `${styles[type]} ${className}`.trim();
